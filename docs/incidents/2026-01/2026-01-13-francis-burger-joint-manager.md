...
last_updated: 2026-01-18T13:00:09
---
...
## Aftermath
Following the incident, Francis Burger Joint closed temporarily. When the East Lake Street location reopened, the restaurant offered a 10 percent discount to customers, though some refused the discount, saying they wanted to support the restaurant.

## Editorial Assessment
**MEDIUM** - Single source (Mpls.St.Paul Magazine) with named co-owner providing direct account. The victim's name is not disclosed but the incident details are specific and the source is a reputable local publication. Additional corroboration would strengthen the rating.
