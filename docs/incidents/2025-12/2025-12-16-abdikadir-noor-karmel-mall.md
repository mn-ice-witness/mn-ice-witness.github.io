...
- **Citizenship:** U.S. Citizen for 20 years
- **Origin:** Somalia

## Timeline
1. **Morning** - Noor goes to get coffee at Karmel Mall
2. **ICE encounter** - Pulled over by ICE agents
3. **Asserts rights** - After Noor asserts his rights, agents target different vehicle with Latino occupants
4. **Crowd gathers** - Tense situation as agents reportedly throw pregnant woman to ground
5. **Arrest** - Noor attempts to calm crowd; is suddenly arrested and thrown to ground
6. **Transport** - Agent refuses to let Noor buckle seatbelt
7. **Processing** - Shackled alone for ~4 hours at Whipple Building
8. **Racist statements** - ICE agent makes anti-Somali comments
9. **Rights read** - Finally read his rights after 4 hours
10. **~6 p.m.** - Released without charges

## Racist Statements by ICE Agent
During processing, an ICE agent made the following statements (as alleged in lawsuit):
- "They all come here fraudulently. Fifty percent are here fraudulently"
...
## Legal Action
Noor is a named plaintiff in the ACLU class-action lawsuit *Tincher v. Noem*, which alleges First and Fourth Amendment violations by ICE agents in Minnesota.

## Editorial Assessment
**HIGH** - Named plaintiff in federal lawsuit with court documentation. Detailed account in lawsuit filing. Clear civil rights violations alleged (racial profiling, racist statements, due process issues). 20-year U.S. citizen status makes this a clear case of targeting based on ethnicity.
