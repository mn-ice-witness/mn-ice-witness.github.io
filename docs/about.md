...
<p class="about-note">Note: Even non-citizens accused of crimes have the right to have their civil rights respected and to be given due process under the law. As the <a href="https://www.aclu.org/issues/immigrants-rights">ACLU states</a>: "The fundamental constitutional protections of due process and equal protection embodied in the Constitution and Bill of Rights apply to every person."</p>
