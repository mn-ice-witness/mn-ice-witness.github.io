...
**What this site shows:** We compile sourced incidents that challenge that narrative. We document U.S. citizens racially profiled while driving, working, or shopping — detained without cause and later released. We document people arrested for filming or observing ICE operations, a First Amendment protected activity. And we document non-criminal immigrants: people who have lived and worked in Minnesota for years, raised families, paid taxes, and followed the rules — some caught in immigration paperwork bureaucracy, others [legally admitted refugees](https://www.globalrefuge.org/news/refugee-arrests-minnesota/) affected by [Operation PARRIS](https://www.uscis.gov/newsroom/news-releases/dhs-launches-landmark-uscis-fraud-investigation-in-minnesota) who were detained and transported to Texas within 24 hours with no access to an attorney. These are the cases that rarely appear in DHS press releases.

**What the data shows:** National data tells a similar story. According to [Fortune](https://fortune.com/2025/07/12/ice-raids-trump-immigration-crackdown-deportation-no-criminal-convictions/), **72% of ICE detainees have no criminal convictions**. The Cato Institute found that **5% of those booked into ICE detention had violent criminal convictions**, while **73% had no convictions at all**. The "Worst of the Worst" database contains **9,738 people** out of more than **220,000 ICE arrests** — approximately **4%** ([Common Dreams](https://www.commondreams.org/news/dhs-worst-of-worst-database)). A [Star Tribune investigation](https://www.startribune.com/the-trump-administration-calls-them-the-worst-of-the-worst-heres-what-we-found/601555390) reviewed the 240 names DHS released and found that while 80% had felony convictions, nearly everyone had already served their time and was not actively wanted by police when detained.
...
<h2 id="local-blame">Federal Position: Local Policies and "Radical Obstruction" <a href="#local-blame" class="header-link" title="Copy link"><svg width="16" height="16"><use href="#icon-link"/></svg></a></h2>

**The administration's argument:** The Trump administration contends that local policies and community resistance are to blame for confrontational enforcement scenes. Border czar Tom Homan stated: "Let us in the damn jail. Frey and Walz could fix this today." DHS stated that sanctuary city policies resulted in the release of ["nearly 470 criminal illegal aliens"](https://www.dhs.gov/news/2026/01/14/mayor-freys-sanctuary-policies-release-criminal-illegal-aliens-jails-back). Following the [fatal shooting of Alex Pretti](#2026-01-24-alex-pretti-shooting), Vice President Vance called it "engineered chaos... the direct consequence of far left agitators, working with local authorities."

**On sanctuary cities:** A [New York Times investigation](https://www.nytimes.com/2026/01/22/us/ice-minnesota-inmates.html) found the situation is more complex: Minnesota state prisons do transfer inmates to ICE upon release (84 last year), but county jails have varying policies — some sheriffs cite legal liability concerns after courts found detaining people solely on ICE requests exceeded their authority.

**On observers:** Many incidents on this site involve people detained while filming or observing ICE. Congressional investigators and journalists have documented civil rights abuses by immigration agents — a [ProPublica investigation](https://www.propublica.org/article/immigration-agents-detained-mistreated-citizens-congressional-investigation) found agents have "often grabbed and mistreated citizens," and a separate investigation documented [agents using banned chokeholds on U.S. citizens](https://www.propublica.org/article/videos-ice-dhs-immigration-agents-using-chokeholds-citizens). This record is why legal observers maintain that witness presence serves a public accountability function.

**What's legally protected:** [Federal courts across at least ten circuits](https://www.eff.org/deeplinks/2025/02/yes-you-have-right-film-ice) have ruled that recording law enforcement in public is a First Amendment right. Verbal criticism — including profanity — is protected under [*City of Houston v. Hill* (1987)](https://en.wikipedia.org/wiki/Contempt_of_cop). Whistles, chanting, and singing are [protected activities](https://www.aclu.org/know-your-rights/protesters-rights). Physical obstruction — blocking officers, surrounding vehicles, or stepping between an agent and a detainee — is not protected and can result in federal charges.

**What the evidence shows:** DHS has cited [hostile crowds creating unsafe conditions](/entry/2026-01-21-dhs-response-crowd-control) — agents followed to gas stations, food thrown, an agent spit on. But video evidence shows Pretti was holding a phone — not a weapon — and appeared to be filming while attempting to help a woman who had been pushed to the ground. [See full details](#2026-01-25-vance-engineered-chaos-unique). A [ProPublica investigation](https://www.propublica.org/article/immigration-dhs-american-citizens-arrested-detained-against-will) found that of ~130 Americans arrested for allegedly impeding ICE officers, nearly 50 were never charged or had charges dismissed. In [Chicago](https://www.cbsnews.com/chicago/news/charges-dropped-broadview-ice-protesters-grand-jury/) and [Portland](https://www.opb.org/article/2025/12/03/protestors-arrested-at-portland-ice-facility-wait-months-without-charges/), most protester charges were dropped.
