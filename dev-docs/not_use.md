...
This file tracks stories that were considered but determined not to be a good fit for the project. Check this list before adding new incidents to avoid re-adding stories that were already evaluated and rejected.

## Criteria for Exclusion

Stories are excluded when they don't meet the project's core focus:
1. **Protest-only coverage** - Stories that only cover protests/walkouts without a direct civil rights incident
2. **Opinion pieces** - Editorials without factual incident reporting
...
**East Side Thai Gun Drawn (Jan 20)**
...
- Sources: [Northern News Now](https://www.northernnewsnow.com/2025/10/29/ice-raids-two-hibbing-mexican-restaurants-prompted-by-drug-investigation/), [Fox21](https://www.fox21online.com/2025/10/29/ice-raids-2-mexican-restaurants-in-hibbing-detains-multiple-people/), [Duluth News Tribune](https://www.duluthnewstribune.com/news/local/ice-arrests-8-in-hibbing-drug-sales-allegedly-fueled-restaurants)
- Date: October 29, 2025
- Details: 8 detained at two restaurants owned by same person. One worker (Aracadio Carrera Flores) charged with 3rd-degree cocaine sales and firearm possession by illegal alien. Drug investigation ongoing for a year prior.
- Reason: Criminal investigation - raid was prompted by narcotics operation, not immigration-only enforcement. Lake Superior Violent Offenders Task Force involved.
- Date evaluated: 2026-01-14

**Federal Agents Raid St. Paul Roofing Crew**
- Sources: [Bring Me The News](https://bringmethenews.com/minnesota-news/mayors-alarm-after-ice-raid-sees-masked-agents-seize-workers-from-st-paul-site), [Minnesota Reformer](https://minnesotareformer.com/2025/10/03/federal-raid-in-st-paul-neighborhood-a-rude-awakening-for-community-leaders/)
- Date: October 2025
- Details: Four workers detained (3 from El Salvador, 1 from Honduras). ICE confirmed 3 of 4 had criminal convictions and removal orders.
- Reason: Majority of detainees had criminal convictions - does not fit project focus on non-criminal community members
- Date evaluated: 2026-01-14
